...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		// Current check
		// Connect to the port numbers on the PDP (not the port numbers on the roboRIO!!!)
		/*
		 System.out.println("Total Current: " +
		 Robot.drivetrain.pdp.getTotalCurrent());
		 System.out.print("Left Motors: " + "Motor1: " +
		 Robot.drivetrain.pdp.getCurrent(14) + ",");
		 System.out.print("Motor3: " + Robot.drivetrain.pdp.getCurrent(13) +
		 ",");
		 System.out.print("Motor5: " + Robot.drivetrain.pdp.getCurrent(12) +
		 ",");
		 System.out.print("Right Motors: " + "Motor0: " +
		 Robot.drivetrain.pdp.getCurrent(15) + ",");
		 System.out.print("Motor2: " + Robot.drivetrain.pdp.getCurrent(2) +
		 ",");
		 System.out.print("Motor4: " + Robot.drivetrain.pdp.getCurrent(3) +
		 ",");
		 System.out.println();
		 */
	}
