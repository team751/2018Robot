...
public class MutliSpeedController implements SpeedController{
	    private SpeedController[] speedControllers;
	    private double speed;

	    public MutliSpeedController(SpeedController motor1, SpeedController motor2, SpeedController motor3) {
